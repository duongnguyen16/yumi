...
import { EvidenceFile, EvidenceFileSchema, AdminDecision, AdminDecisionSchema } from './common.embedded';
...
export class Dispute {
  ...
  @Prop({ type: String, enum: DisputeStatus, default: DisputeStatus.OPEN, index: true })
